...
class sceneConstructor(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        # --- Paths (update as needed, these are relative to script folder) ---
        ...
        self.shot_path = r"C:\Users\Dolapo\Desktop\python\static\00_pipeline\shotMaster"
    ...
    # ==========================================================
    #   (keeping your existing functions mostly unchanged below)
    # ==========================================================
        ...
        for item in data:
            if item['type'] in self.actor_types:
                ...
                for i in range(self.preset_table.topLevelItemCount()):
                    top = self.preset_table.topLevelItem(i)
    ...
    def show_shot_items(self, text):
        ...
        self.shot_path = r"C:\Users\Dolapo\Desktop\python\static\00_pipeline\shotMaster"
        #os.path.join(self.scene_path,self.currentScene,text,'SceneConstructor')

        print(self.shot_path)
        pipeline_files = os.listdir(self.shot_path)
        ...
        for file in pipeline_files:
            if os.path.isfile(os.path.join(self.shot_path,file)) == True:
                if file.lower().endswith('.json'):
                    self.shot_json_path = os.path.join(self.shot_path,file)
